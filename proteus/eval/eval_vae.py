...
from proteus.utils.generation_utils import save_pdb
from proteus.utils.struct_utils import compute_rmsd, coords_from_txy_sincos
...
class EvalVAE:
    ...
    def load_checkpoint(self, checkpoint_path: str) -> Proteus:
